...
" 20 76 5 \
    ...
    "Horde Webmail" "Horde Groupware & Webmail." "off" \
...
echo ${OPTIONAL_COMPONENTS} | grep -i 'Horde' >/dev/null 2>&1
[ X"$?" == X"0" ] && export USE_WEBMAIL='YES' && export USE_HORDE='YES' && echo "export USE_HORDE='YES'" >>${CONFIG_FILE}
