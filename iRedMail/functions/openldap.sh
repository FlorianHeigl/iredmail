...
# Domain attrs.
access to attrs="objectclass,${LDAP_ATTR_DOMAIN_DN_NAME},${LDAP_ATTR_DOMAIN_TRANSPORT},${LDAP_ATTR_DOMAIN_STATUS},${LDAP_ENABLED_SERVICE},${LDAP_ATTR_DOMAIN_SENDER_BCC_ADDRESS},${LDAP_ATTR_DOMAIN_RECIPIENT_BCC_ADDRESS}"
    by anonymous    auth
    by self         read
    by dn.exact="${LDAP_BINDDN}"   read
    by dn.exact="${LDAP_ADMIN_DN}"  write
...
#
index ${LDAP_ATTR_DOMAIN_DN_NAME},${LDAP_ATTR_DOMAIN_TRANSPORT},${LDAP_ATTR_DOMAIN_STATUS},${LDAP_ENABLED_SERVICE}  eq,pres
...
dn: ou=Users,${LDAP_ATTR_DOMAIN_DN_NAME}=${FIRST_DOMAIN},${LDAP_BASEDN}
objectClass: organizationalUnit
objectClass: top
ou: Users

dn: ou=Groups,${LDAP_ATTR_DOMAIN_DN_NAME}=${FIRST_DOMAIN},${LDAP_BASEDN}
objectClass: organizationalUnit
objectClass: top
ou: Groups

dn: ${LDAP_ATTR_USER_DN_NAME}=${DOMAIN_ADMIN_NAME}@${FIRST_DOMAIN},ou=Users,${LDAP_ATTR_DOMAIN_DN_NAME}=${FIRST_DOMAIN},${LDAP_BASEDN}
...
mailMessageStore: ${FIRST_DOMAIN}/${DOMAIN_ADMIN_NAME}/
...
dn: ${LDAP_ATTR_USER_DN_NAME}=${FIRST_USER}@${FIRST_DOMAIN},ou=Users,${LDAP_ATTR_DOMAIN_DN_NAME}=${FIRST_DOMAIN},${LDAP_BASEDN}
objectClass: inetOrgPerson
objectClass: ${LDAP_OBJECTCLASS_MAILUSER}
objectClass: top
cn: ${FIRST_USER}
