...
# Domain attrs.
access to attrs="objectclass,${LDAP_ATTR_DOMAIN_DN_NAME},${LDAP_ATTR_DOMAIN_TRANSPORT},${LDAP_ATTR_DOMAIN_STATUS},${LDAP_ATTR_ENABLE_MAIL_SERVICE},${LDAP_ATTR_DOMAIN_ENABLE_IM_SERVICE},${LDAP_ATTR_DOMAIN_ENABLE_FTP_SERVICE},${LDAP_ATTR_DOMAIN_SENDER_BCC_ADDRESS},${LDAP_ATTR_DOMAIN_RECIPIENT_BCC_ADDRESS}"
    by anonymous    auth
    by self         read
    by dn.exact="${LDAP_BINDDN}"   read
    by dn.exact="${LDAP_ADMIN_DN}"  write
...
#
index ${LDAP_ATTR_DOMAIN_DN_NAME},${LDAP_ATTR_DOMAIN_TRANSPORT},${LDAP_ATTR_DOMAIN_STATUS},${LDAP_ATTR_ENABLE_MAIL_SERVICE},${LDAP_ATTR_DOMAIN_ENABLE_IM_SERVICE},${LDAP_ATTR_DOMAIN_ENABLE_FTP_SERVICE}  eq,pres
