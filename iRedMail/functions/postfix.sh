...
scope           = sub
query_filter    = (&(objectClass=${LDAP_OBJECTCLASS_MAILUSER})(${LDAP_ATTR_USER_DN_NAME}=%s)(${LDAP_ATTR_USER_STATUS}=active)(${LDAP_ENABLED_SERVICE}=${LDAP_SERVICE_MAIL}))
...
search_base     = ${LDAP_ATTR_DOMAIN_DN_NAME}=%d,${LDAP_BASEDN}
scope           = sub
query_filter    = (&(objectClass=${LDAP_OBJECTCLASS_MAILUSER})(${LDAP_ATTR_USER_DN_NAME}=%s)(${LDAP_ATTR_USER_STATUS}=active)(${LDAP_ENABLED_SERVICE}=${LDAP_SERVICE_MAIL})(${LDAP_ENABLED_SERVICE}=${LDAP_SERVICE_DELIVER}))
...
search_base     = ${LDAP_ATTR_DOMAIN_DN_NAME}=%d,${LDAP_BASEDN}
scope           = sub
query_filter    = (&(${LDAP_ATTR_USER_DN_NAME}=%s)(objectClass=${LDAP_OBJECTCLASS_MAILUSER})(${LDAP_ATTR_USER_STATUS}=active)(${LDAP_ENABLED_SERVICE}=${LDAP_SERVICE_MAIL})(${LDAP_ENABLED_SERVICE}=${LDAP_SERVICE_SMTP}))
result_attribute= ${LDAP_ATTR_USER_DN_NAME}
debuglevel     = 0
EOF
...
search_base     = ${LDAP_ATTR_DOMAIN_DN_NAME}=%d,${LDAP_BASEDN}
scope           = sub
query_filter    = (&(${LDAP_ATTR_USER_DN_NAME}=%s)(objectClass=${LDAP_OBJECTCLASS_MAILUSER})(${LDAP_ATTR_USER_STATUS}=active)(${LDAP_ENABLED_SERVICE}=${LDAP_SERVICE_MAIL}))
...
search_base     = ${LDAP_BASEDN}
scope           = one
query_filter    = (&(${LDAP_ATTR_DOMAIN_DN_NAME}=%d)(objectClass=${LDAP_OBJECTCLASS_MAILDOMAIN})(${LDAP_ATTR_DOMAIN_STATUS}=active)(${LDAP_ENABLED_SERVICE}=${LDAP_SERVICE_MAIL}))
