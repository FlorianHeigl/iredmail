...
EOF
    ...
    ALL_PKGS="${ALL_PKGS} p5-MIME-Tools p5-IO-stringy p5-Unix-Syslog p5-Net-Server p5-Convert-TNEF p5-Convert-UUlib p5-Archive-Zip p5-Authen-SASL amavisd-new"
    ALL_PORTS="${ALL_PORTS} devel/p5-IO-stringy mail/p5-MIME-Tools net/p5-Net-Server sysutils/p5-Unix-Syslog converters/p5-Convert-TNEF converters/p5-Convert-UUlib archivers/p5-Archive-Zip security/p5-Authen-SASL security/amavisd-new"
