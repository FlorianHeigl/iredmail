...
extmail_install()
{
    ...
    ECHO_INFO "Patch ExtMail, make it create user maildir automatic, don't show the welcome msg, typo in index page."
    ...
    patch -p0 < ${PATCH_DIR}/extmail/index.html.patch >/dev/null 2>&1
