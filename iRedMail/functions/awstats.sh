...
<Directory ${AWSTATS_HTTPD_ROOT}/>
    ...
    AuthLDAPUrl   ldap://${LDAP_SERVER_HOST}:${LDAP_SERVER_PORT}/o=${LDAP_ATTR_DOMAINADMIN_DN_NAME},${LDAP_SUFFIX}?${LDAP_ATTR_USER_DN_NAME}?sub?(${LDAP_ATTR_USER_STATUS}=${LDAP_STATUS_ACTIVE})
