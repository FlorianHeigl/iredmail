...
sub graph_grey($$)
{
        ...
        rrd_graph($range, $file, $ypoints_grey,
                ...
                "AREA:rgreylisted#$color{greylisted}:Policyd      ",
                ...
                "DEF:helo_rejected=$rrd_greylist:helo_rejected:AVERAGE",
                "DEF:mhelo_rejected=$rrd_greylist:helo_rejected:MAX",
                "CDEF:rhelo_rejected=helo_rejected,60,*",
                "CDEF:dhelo_rejected=helo_rejected,UN,0,helo_rejected,IF,$step,*",
                "CDEF:shelo_rejected=PREV,UN,dhelo_rejected,PREV,IF,dhelo_rejected,+",
                "CDEF:rmhelo_rejected=mhelo_rejected,60,*",
                "LINE2:rhelo_rejected#$color{helo_rejected}:Helo Rejected",
                'GPRINT:shelo_rejected:MAX:total\: %8.0lf msgs',
                'GPRINT:rhelo_rejected:AVERAGE:avg\: %5.2lf msgs/min',
                'GPRINT:rmhelo_rejected:MAX:max\: %4.0lf msgs/min\l',
        );
}
